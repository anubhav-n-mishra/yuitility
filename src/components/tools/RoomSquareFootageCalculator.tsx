        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={`px-3 py-1.5 rounded-xl text-xs font-semibold transition ${
              unit === 'ft' ? 'bg-indigo-600 text-white' : 'bg-zinc-100 dark:bg-zinc-800 text-zinc-500 dark:text-zinc-400 hover:text-white'
            }`}
          >
            Feet (sq ft)
          </button>
          <button
            ...
            onClick={() => setUnit('m')}
            className={`px-3 py-1.5 rounded-xl text-xs font-semibold transition ${
              unit === 'm' ? 'bg-indigo-600 text-white' : 'bg-zinc-100 dark:bg-zinc-800 text-zinc-500 dark:text-zinc-400 hover:text-white'
            }`}
          >
            Meters (sq m)
          </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white dark:bg-zinc-900/60 shadow-sm p-6 rounded-2xl border border-zinc-200 dark:border-zinc-800 space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-semibold text-zinc-900 dark:text-white">Room Dimensions</h3>
            <button
              type="button"
              onClick={addRoom}
                ...
                >
                  <div className="w-36">
                    <input
                      ...
                      className="w-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg px-2.5 py-1.5 text-white text-xs"
                    />
                  </div>
                  ...
                  <div className="flex-1">
                    <input
                      ...
                      className="w-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg px-2.5 py-1.5 text-white font-mono text-xs"
                    />
                  </div>
                  ...
                  <span className="w-24 text-right font-mono text-xs text-indigo-600 dark:text-indigo-400 font-bold shrink-0">
                  ...
                  <button
                    ...
                    className="p-1.5 text-zinc-500 dark:text-zinc-500 hover:text-rose-600 dark:text-rose-400 disabled:opacity-30 transition"
                  >
          ...
          <div className="pt-3 border-t border-zinc-200 dark:border-zinc-800 flex items-center justify-between">
            <label className="text-xs text-zinc-500 dark:text-zinc-400">Estimated Cost per {unit === 'ft' ? 'sq ft' : 'sq m'}:</label>
            <div className="w-32">
              <input
                type="number"
                step="0.5"
                ...
                className="w-full bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-lg px-2.5 py-1.5 text-white font-mono text-xs text-right"
              />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900/60 shadow-sm p-6 rounded-2xl border border-zinc-200 dark:border-zinc-800 flex flex-col justify-between">
          <div>
            ...
            <div className="text-5xl font-black font-mono text-white my-2">
              {sqFt.toFixed(1)}
              <span className="text-lg font-normal text-zinc-500 dark:text-zinc-400"> sq ft</span>
            </div>
            ...
            <div className="space-y-3 mt-4 pt-4 border-t border-zinc-200 dark:border-zinc-800 font-mono text-xs">
              ...
              {costPerUnit > 0 && (
                <div className="p-3 bg-zinc-50 dark:bg-zinc-950 rounded-xl border border-zinc-200 dark:border-zinc-800 flex justify-between items-center text-sm">
                  <span className="text-zinc-500 dark:text-zinc-400">Total Material Cost:</span>
                  <span className="font-bold text-emerald-600 dark:text-emerald-400 font-mono">${totalCost.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                </div>
              )}
            </div>
          </div>
