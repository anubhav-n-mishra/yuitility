    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-zinc-900/60 shadow-sm p-6 rounded-2xl border border-zinc-200 dark:border-zinc-800 space-y-4">
          <h3 className="text-sm font-semibold text-zinc-900 dark:text-white">Bodyweight & Goal</h3>
          ...
          <div>
            <label className="text-xs text-zinc-700 dark:text-zinc-300 block mb-2">Training Goal</label>
              ...
              {[
                ...
                >
                  <div>
                    ...
                    <div className="text-[11px] text-zinc-500 dark:text-zinc-500 font-mono mt-0.5">{g.desc}</div>
                  </div>
                </button>
              ))}
            </div>
        ...
        <div className="bg-white dark:bg-zinc-900/60 shadow-sm p-6 rounded-2xl border border-zinc-200 dark:border-zinc-800 flex flex-col justify-between">
          <div>
            ...
            {results && (
              <div className="mt-5 pt-4 border-t border-zinc-200 dark:border-zinc-800 space-y-2.5">
                <span className="text-xs font-semibold text-zinc-700 dark:text-zinc-300 block flex items-center gap-1.5">
                  <UtensilsCrossed className="w-3.5 h-3.5 text-indigo-600 dark:text-indigo-400" /> Whole Food Equivalents ({results.avgGrams}g)
                </span>
                <div className="grid grid-cols-3 gap-2 font-mono text-xs">
                  <div className="p-2.5 bg-zinc-50 dark:bg-zinc-950 rounded-xl border border-zinc-200 dark:border-zinc-800 text-center">
                    <span className="text-zinc-500 dark:text-zinc-500 text-[10px] block">Chicken Breast</span>
                    <span className="text-white font-bold">{results.chickenBreastGrams}g</span>
                  </div>
                  <div className="p-2.5 bg-zinc-50 dark:bg-zinc-950 rounded-xl border border-zinc-200 dark:border-zinc-800 text-center">
                    <span className="text-zinc-500 dark:text-zinc-500 text-[10px] block">Whole Eggs</span>
                    <span className="text-white font-bold">{results.eggsCount} eggs</span>
                  </div>
                  <div className="p-2.5 bg-zinc-50 dark:bg-zinc-950 rounded-xl border border-zinc-200 dark:border-zinc-800 text-center">
                    <span className="text-zinc-500 dark:text-zinc-500 text-[10px] block">Whey Scoops</span>
