...
export const TOOLS: Tool[] = [
  ...
  // New Phase 1 & 2 Tools Additions
  { id: "case-converter", title: "Text Case Converter", description: "Convert text between UPPERCASE, lowercase, Title Case, camelCase, snake_case, and kebab-case.", longDescription: "Instant client-side text case transformation tool.", category: "developer", icon: "Type", popular: true, recentlyAdded: true, cta: "Convert Case" },
  { id: "character-counter", title: "Character & Limit Counter", description: "Count characters, words, sentences, reading time, and social platform limit progress.", longDescription: "Track letter and word counts against Twitter, SEO title, and LinkedIn limits.", category: "developer", icon: "AlignLeft", popular: false, recentlyAdded: true, cta: "Count Characters" },
  { id: "duplicate-line-remover", title: "Duplicate Line Remover", description: "Remove duplicate lines from text lists with sorting and trimming options.", longDescription: "Deduplicate lines of text and clean data sets client-side.", category: "developer", icon: "Filter", popular: false, recentlyAdded: true, cta: "Remove Duplicates" },
  { id: "text-reverser", title: "Text Reverser & Flip Text", description: "Reverse string order, word order, or flip text upside-down instantly.", longDescription: "Reverse text character order, words, or generate flipped upside-down text.", category: "developer", icon: "Repeat", popular: false, recentlyAdded: true, cta: "Reverse Text" },
  { id: "text-repeater", title: "Text & String Repeater", description: "Repeat any string N times with custom separators and line breaks.", longDescription: "Generate repeated text strings up to 5000 times for testing or social media.", category: "developer", icon: "Repeat", popular: false, recentlyAdded: true, cta: "Repeat Text" },
  { id: "slug-generator", title: "URL Slug Generator", description: "Convert titles and headlines into SEO-friendly clean URL slugs.", longDescription: "Transform text into clean, URL-safe slugs with customizable separators.", category: "developer", icon: "Link2", popular: true, recentlyAdded: true, cta: "Generate Slug" },
  { id: "text-to-ascii-art", title: "Text to ASCII Art Generator", description: "Generate big ASCII text banner art for code README files.", longDescription: "Convert plain text titles into terminal ASCII art banners.", category: "developer", icon: "Sparkles", popular: false, recentlyAdded: true, cta: "Generate ASCII" },
  { id: "text-cleaner", title: "Text Cleaner & Extra Space Remover", description: "Strip HTML tags, collapse extra whitespace, and join paragraphs.", longDescription: "Clean messy copied text by stripping tags, extra spaces, and empty lines.", category: "developer", icon: "Eraser", popular: true, recentlyAdded: true, cta: "Clean Text" },
  { id: "css-minifier-beautifier", title: "CSS Minifier & Formatter", description: "Minify or beautify CSS stylesheets with compression size metrics.", longDescription: "Compress CSS files or format dirty CSS with clean indentation.", category: "developer", icon: "Code", popular: true, recentlyAdded: true, cta: "Minify CSS" },
  { id: "js-minifier-beautifier", title: "JavaScript Minifier & Formatter", description: "Minify JS scripts or format JavaScript code cleanly.", longDescription: "Compress JavaScript files or beautify messy code structures.", category: "developer", icon: "Code2", popular: true, recentlyAdded: true, cta: "Minify JS" },
  { id: "html-formatter", title: "HTML Formatter & Minifier", description: "Beautify dirty HTML markup or collapse HTML for fast page loads.", longDescription: "Format HTML document trees or minify HTML markup.", category: "developer", icon: "FileCode", popular: false, recentlyAdded: true, cta: "Format HTML" },
  { id: "json-to-csv-converter", title: "JSON to CSV Converter", description: "Convert JSON array data into downloadable CSV spreadsheets.", longDescription: "Transform JSON data arrays into formatted CSV files with custom delimiters.", category: "developer", icon: "ArrowRightLeft", popular: true, recentlyAdded: true, cta: "Convert to CSV" },
  { id: "color-format-converter", title: "Color Format Converter (HEX, RGB, HSL)", description: "Convert color codes across HEX, RGB, HSL, CMYK, and CSS variables.", longDescription: "Convert color values seamlessly across HEX, RGB, HSL, and CMYK formats.", category: "developer", icon: "Palette", popular: true, recentlyAdded: true, cta: "Convert Color" },
  { id: "pomodoro-timer", title: "Pomodoro Focus Timer", description: "Boost productivity with 25-minute focus cycles and break alarms.", longDescription: "Stay focused with Pomodoro work and break interval timers.", category: "utility", icon: "Clock", popular: true, recentlyAdded: true, cta: "Start Timer" },
  { id: "countdown-timer", title: "Event Countdown Timer", description: "Track days, hours, minutes, and seconds until your target event.", longDescription: "Create custom live event countdown timers with shareable links.", category: "utility", icon: "Timer", popular: true, recentlyAdded: true, cta: "Create Countdown" },
  { id: "world-clock", title: "World Clock & Time Zone Tracker", description: "Track live current times across global cities and time zones.", longDescription: "View real-time clocks for global business centers and time zones.", category: "utility", icon: "Globe", popular: true, recentlyAdded: true, cta: "Open World Clock" },
  { id: "number-base-converter", title: "Binary / Hex / Decimal Base Converter", description: "Convert numbers between Binary (2), Octal (8), Decimal (10), and Hex (16).", longDescription: "Convert numerical representations across Binary, Octal, Decimal, and Hexadecimal.", category: "math", icon: "Binary", popular: true, recentlyAdded: true, cta: "Convert Base" },
  { id: "jwt-decoder", title: "JWT Token Decoder", description: "Decode JSON Web Tokens (JWT) to inspect header and payload claims securely.", longDescription: "Decode JWT strings 100% locally in browser tab to verify claims.", category: "developer", icon: "KeyRound", popular: true, recentlyAdded: true, cta: "Decode JWT" },
  { id: "meeting-cost-calculator", title: "Meeting Cost Calculator", description: "Calculate real-time financial burn rates and costs of meetings.", longDescription: "Measure dollar cost per minute of business meetings based on attendee rates.", category: "finance", icon: "DollarSign", popular: false, recentlyAdded: true, cta: "Calculate Cost" },
  { id: "age-in-seconds-calculator", title: "Age in Seconds & Days Calculator", description: "Calculate exact age breakdown in seconds, minutes, hours, and days.", longDescription: "Discover your exact chronological age in total seconds, hours, and days lived.", category: "utility", icon: "Calendar", popular: false, recentlyAdded: true, cta: "Calculate Age" },
  { id: "read-time-estimator", title: "Article Read Time Estimator", description: "Estimate reading times for fast, average, and slow reader speeds.", longDescription: "Calculate estimated reading time in minutes for blog posts and articles.", category: "utility", icon: "BookOpen", popular: false, recentlyAdded: true, cta: "Estimate Read Time" },
  { id: "sip-step-up-calculator", title: "SIP Step-Up Calculator", description: "Calculate mutual fund wealth accumulation with annual step-up increments.", longDescription: "Forecast SIP compounding returns with top-up annual step-up increases.", category: "finance", icon: "TrendingUp", popular: true, recentlyAdded: true, cta: "Calculate Step-Up" },
  { id: "ssy-calculator", title: "Sukanya Samriddhi Yojana (SSY) Calculator", description: "Calculate SSY scheme interest returns and maturity corpus.", longDescription: "Calculate government SSY interest returns and 21-year maturity payout.", category: "finance", icon: "PiggyBank", popular: true, recentlyAdded: true, cta: "Calculate SSY" },
  { id: "crypto-profit-calculator", title: "Crypto Profit / Loss Calculator", description: "Calculate cryptocurrency buy/sell trade profits, ROI %, and fees.", longDescription: "Calculate net crypto trading profit or loss considering buy/sell prices and exchange fees.", category: "finance", icon: "Coins", popular: true, recentlyAdded: true, cta: "Calculate Profit" },
  { id: "calorie-deficit-calculator", title: "Calorie Deficit & Surplus Calculator", description: "Determine daily calorie targets for weight loss or muscle gain.", longDescription: "Calculate daily calorie intake target for fat loss or muscle building.", category: "health", icon: "Activity", popular: true, recentlyAdded: true, cta: "Calculate Deficit" },
  { id: "ohms-law-calculator", title: "Ohm's Law Calculator (V = I × R)", description: "Calculate voltage, current, resistance, and electrical power.", longDescription: "Solve Ohm's law equations for Voltage, Current, Resistance, and Power.", category: "math", icon: "Zap", popular: true, recentlyAdded: true, cta: "Solve Ohm's Law" },
  { id: "power-consumption-calculator", title: "Appliance Power & Electricity Bill Calculator", description: "Calculate daily/monthly kWh power usage and electricity bill costs.", longDescription: "Estimate electricity bill costs for home appliances based on wattage and usage.", category: "utility", icon: "Zap", popular: true, recentlyAdded: true, cta: "Calculate Power" },
  { id: "speed-distance-time-calculator", title: "Speed, Distance & Time Calculator", description: "Solve physics equations for travel speed, distance, or ETA time.", longDescription: "Calculate speed, distance, or travel duration for trips and physics problems.", category: "math", icon: "Gauge", popular: true, recentlyAdded: true, cta: "Calculate Speed" },
  { id: "image-color-picker", title: "Image Eyedropper & Color Picker", description: "Upload any image to pick pixel color codes (HEX, RGB) instantly.", longDescription: "Extract exact pixel color hex codes from uploaded images locally.", category: "media", icon: "Pipette", popular: true, recentlyAdded: true, cta: "Pick Color" },
  { id: "image-flipper", title: "Image Flip & Rotate Tool", description: "Flip images horizontally, vertically, or rotate by 90-degree angles.", longDescription: "Mirror or rotate image orientation in-browser.", category: "media", icon: "RotateCw", popular: false, recentlyAdded: true, cta: "Flip Image" },
  { id: "svg-to-png-converter", title: "SVG to PNG Converter", description: "Convert SVG vector images into high-resolution PNG downloads.", longDescription: "Rasterize vector SVG files to high-definition PNG images.", category: "media", icon: "FileCode", popular: true, recentlyAdded: true, cta: "Convert SVG" },
  { id: "password-strength-checker", title: "Password Strength & Audit Checker", description: "Evaluate password security score, entropy, and character rules.", longDescription: "Analyze password strength, entropy bits, and vulnerabilities 100% locally.", category: "developer", icon: "ShieldCheck", popular: true, recentlyAdded: true, cta: "Check Password" },
  { id: "text-encryptor", title: "Text Encryptor & Decryptor (AES)", description: "Encrypt sensitive text with a secret key passphrase securely.", longDescription: "Encrypt and decrypt text strings using local secret key passphrases.", category: "developer", icon: "Lock", popular: false, recentlyAdded: true, cta: "Encrypt Text" },
  { id: "file-hash-verifier", title: "File SHA-256 Hash Verifier", description: "Compute and verify SHA-256 checksums for local files to check integrity.", longDescription: "Compute file SHA-256 checksums locally in browser using Web Crypto.", category: "developer", icon: "ShieldCheck", popular: true, recentlyAdded: true, cta: "Verify Hash" },
  { id: "exif-data-viewer", title: "Photo EXIF Metadata Inspector", description: "View embedded camera EXIF data and metadata from image files.", longDescription: "Inspect hidden EXIF metadata fields from digital photographs.", category: "media", icon: "Eye", popular: false, recentlyAdded: true, cta: "View EXIF" }
];
